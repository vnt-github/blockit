...
def make_text(text,color,bgcolor,top,left,size=50):
    FONT_OBJECT=pygame.font.Font('freesansbold.ttf',size)
    if bgcolor!=None:
        text_surf=FONT_OBJECT.render(text,True,color,bgcolor)
    else:
        text_surf=FONT_OBJECT.render(text,True,color)#if no background color is provided then the background is transparent
    text_rect=text_surf.get_rect()
    text_rect.topleft=(top,left)
    return (text_surf,text_rect)

new_image_up=pygame.image.load("new_button_up.png")
new_image_up=pygame.transform.scale(new_image_up,(BUTTON_WIDTH,BUTTON_HEIGHT))
new_image_down=pygame.image.load("new_button_down.png")
new_image_down=pygame.transform.scale(new_image_down,(BUTTON_WIDTH,BUTTON_HEIGHT))
new_rect=new_image_up.get_rect()
new_rect.bottomright=WINDOW_WIDTH,WINDOW_HEIGHT

undo_image_up=pygame.image.load("undo_button_up.png")
undo_image_up=pygame.transform.scale(undo_image_up,(BUTTON_WIDTH,BUTTON_HEIGHT))
undo_image_down=pygame.image.load("undo_button_down.png")
undo_image_down=pygame.transform.scale(undo_image_down,(BUTTON_WIDTH,BUTTON_HEIGHT))
undo_rect=undo_image_up.get_rect()
undo_rect.bottomleft=0,WINDOW_HEIGHT
previous_first_time=None

OVER_RIDE_SURF,OVER_RIDE_RECT=make_text("override!!",BLACK,None,0,0)
...
def display_start():
    ...
    TWO_IMAGE=pygame.image.load("two_button_up.png")
    TWO_IMAGE=pygame.transform.scale(TWO_IMAGE,(BUTTON_WIDTH,BUTTON_HEIGHT))
    TWO_IMAGE_DOWN=pygame.image.load("two_button_down.png")
    ...
    FOUR_IMAGE=pygame.image.load("four_button_up.png")
    FOUR_IMAGE=pygame.transform.scale(FOUR_IMAGE,(BUTTON_WIDTH,BUTTON_HEIGHT))
    FOUR_IMAGE_DOWN=pygame.image.load("four_button_down.png")
    ...
    SIX_IMAGE=pygame.image.load("six_button_up.png")
    SIX_IMAGE=pygame.transform.scale(SIX_IMAGE,(BUTTON_WIDTH,BUTTON_HEIGHT))
    SIX_IMAGE_DOWN=pygame.image.load("six_button_down.png")
    ...
    EIGHT_IMAGE=pygame.image.load("eight_button_up.png")
    EIGHT_IMAGE=pygame.transform.scale(EIGHT_IMAGE,(BUTTON_WIDTH,BUTTON_HEIGHT))
    EIGHT_IMAGE_DOWN=pygame.image.load("eight_button_down.png")
    ...
    #
    player2_0=pygame.image.load("player2_0.png")
    ...
    player2_1=pygame.image.load("player2_1.png")
    ...
    player2_2=pygame.image.load("player2_2.png")
    ...
    player2_3=pygame.image.load("player2_3.png")
    ...
    player1_0=pygame.image.load("player1_0.png")
    ...
    player1_1=pygame.image.load("player1_1.png")
    ...
    player1_2=pygame.image.load("player1_2.png")
    ...
    player1_3=pygame.image.load("player1_3.png")
...
def draw_board(FIRST_PLAYER):
    ...
    player2_bgcolor=WHITE
    if not first_time:
        if FIRST_PLAYER==PLAYER1:
            player1_bgcolor=BACKGROUND
            OVER_RIDE_RECT.topleft=0,0
        elif FIRST_PLAYER==PLAYER2:
            player2_bgcolor=BACKGROUND
            OVER_RIDE_RECT.topright=WINDOW_WIDTH,0
    
    PLAYER2_SURF,PLAYER2_RECT=make_text(PLAYER2,player2_bgcolor,None,0,0)
    PLAYER2_RECT.top=BOARD_Y_PLACE+r_c*BLOCK_SIZE/4
    PLAYER2_RECT.left=BOARD_X_PLACE+r_c*(BLOCK_SIZE)+r_c*BLOCK_WIDTH

    PLAYER2_SCORE_SURF,PLAYER2_SCORE_RECT=make_text(str(player2_score),WHITE,None,0,0,120)
    PLAYER2_SCORE_RECT.top=PLAYER2_RECT.bottom+PLAYER2_RECT.height/4
    PLAYER2_SCORE_RECT.right=PLAYER2_RECT.right
    
    PLAYER1_SURF,PLAYER1_RECT=make_text(PLAYER1,player1_bgcolor,None,0,0)
    PLAYER1_RECT.top=BOARD_Y_PLACE+r_c*BLOCK_SIZE/4
    PLAYER1_RECT.right=BOARD_X_PLACE-BLOCK_WIDTH-r_c*BLOCK_WIDTH

    PLAYER1_SCORE_SURF,PLAYER1_SCORE_RECT=make_text(str(player1_score),BLACK,None,0,0,120)
    PLAYER1_SCORE_RECT.top=PLAYER1_RECT.bottom+PLAYER1_RECT.height/4
    PLAYER1_SCORE_RECT.left=PLAYER1_RECT.left
