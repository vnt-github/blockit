...
class BuildExe:
    def __init__(self):
        ...
        self.license = "vnt License"
 
        #Auhor of program
        self.author_name = "vineet bharot"
        self.author_email = "vineetbharot@gmail.com"
        self.copyright = "Copyright (c) 2009 vnt."
 
        #Description
        self.project_description = "2 player puzzler"
 
        #Icon file (None will use pygame default icon)
        self.icon_file =None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["images","sounds","fonts_and_extras"]
